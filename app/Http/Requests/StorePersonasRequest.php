...
class StorePersonasRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'idcv' => 'required|exists:statuscv,idcv', 
    ...
    public function messages()
    {
        return [
            ...
            'tipoper.in' => 'El tipo de persona debe ser "civil" o "militar".',
            ...
            'idciv.required' => 'El ID civil es obligatorio.',
            'idciv.exists' => 'El ID civil seleccionada no existe.',
